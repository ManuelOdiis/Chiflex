    ...
    <div className="pt-16 xl:pt-32" id="projects">
        <div className="container max-auto">
            <div className="text-center max-w-[540px] mx-auto xl:mb-20">
                ...
                Dive into a curated collection of footwear that caters to every taste and occasion  
                </p>
            </div>
            </div>
                ...
                {productData.map((item, index) => {
                    return <div key={index} className="w-full h-[492px] flex-1 relative overflow-hidden group flex justify-center">
                      ...
                      <div className="w-[90%] h-[84px] bg-primary absolute bottom-4 flex justify-between items-center text-white md:translate-y-[108px] md:group-hover:translate-y-0 transition-all duration-500">
                        ...
                        <Link href={item.href} className="w-[44px] xl:w-[40px] xl:h-[40px] h-[44px] xl:mt-8 bg-orange-600 text-primary text-2xl flex justify-center items-center absolute right-3">
                        <RiArrowRightUpLine />
                        </Link>
                      </div>
                    </div>
